...
RESULTS_DIR=profile_results/mxnet_tcu_nhwc/nsight/${GPU_NAME}
...
for BATCH_SIZE in "${batch_sizes[@]}"; do
    ...
    ${NSYS} profile --force-overwrite=true --trace=cuda,cudnn,cublas,nvtx --sample=none --output=${NSIGHT_PATH} --export=sqlite  python tcu/run_mxnet_nhwc.py ${BATCH_SIZE_OPT} --num_warmup=$NUM_WARMUP --num_iterations=$NUM_ITERATIONS --model_idx=$MODEL_IDX
