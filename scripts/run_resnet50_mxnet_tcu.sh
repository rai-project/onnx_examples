...
RESULTS_DIR=results/mxnet_tcu/cudnn_log/${GPU_NAME}
...
for BATCH_SIZE in "${batch_sizes[@]}"; do
    ...
    python tcu/run_mxnet.py ${BATCH_SIZE_OPT} --num_warmup=$NUM_WARMUP --num_iterations=$NUM_ITERATIONS --model_idx=$MODEL_IDX
done
